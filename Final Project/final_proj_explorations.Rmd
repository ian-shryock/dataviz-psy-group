...
Student with Disability Rates by State
...
SpEd Revenue per Student by State
...
```
<br>
Washington State has the highest average revenue in SpEd.

Row {.tabset data-height=`r data_height`}
-------------------------------------

Difference in Non-CWD/CWD Grad Rates by State
...
```
<br>
Mississippi and Louisianan have the largest differences in Non-CWD/CWD Grad Rates
