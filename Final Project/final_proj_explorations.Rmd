...
#library(albersusa)
#this is not actually working for me still, FYI
...
#  geom_col(fill = "cornflowerblue", alpha = .9)+
# trying this with a different fill and width
    geom_col(aes(fill=STATENAME,width=.8,alpha=.9))+
    coord_flip() +
  labs(
...
# adding some color here, not sure what the original purpose of the graph is - here the colors vary based on the ALL_RATE
  geom_point(aes(fill = ALL_RATE),size=2, shape=23)+
