...
FZPlot3 <- plot_geo(stateLevel_geo, locationmode = 'USA-states') %>% 
  ...
  colorbar(title = "Differences in Grad Rates\n(No Disabilties - Disabilities)",
           ...
           y = 0.75) %>% 
  layout(
    title = list(text = '<b> Differences in CWD/Non-CWD Grad Rates <b>'),
    y = 0.5,
    geo = g
  )
...
#        y = expression("Median Local Income" %->% ""))+
...
<br>
"DESCRIPTION HERE
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec eros lacus. Vivamus sed leo id mauris commodo tristique nec id justo. Maecenas ut tortor suscipit, venenatis lacus non, laoreet odio. Quisque ultrices, metus id iaculis pretium, nisi lacus ornare felis, non lacinia nunc leo eget nibh. Curabitur quis feugiat sapien. Morbi maximus neque sed porta dignissim. Donec iaculis placerat diam, eget fermentum velit posuere a. Vestibulum at egestas magna. Nam dignissim pulvinar velit non vulputate. Aenean eu nisl vel est ullamcorper pulvinar non sit amet turpis. Quisque finibus augue at turpis pellentesque, sit amet tempor nibh posuere."
